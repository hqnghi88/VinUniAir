...
//	}
	...
	output synchronized: false {
		...
		display main type: opengl background: #black axes: false {
			...
			species building aspect: border  refresh: false position: {3900, 0, 0} size: {sub_scale, sub_scale};
			...
			species building  aspect: border refresh: false position: {3900, 1500, 0} size: {sub_scale, sub_scale};
			...
			species building aspect: border refresh: false size: {0.9, 0.9};
